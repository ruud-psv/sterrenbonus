...
export default function AdminPage({ theme }: AdminPageProps) {
  ...
  const commitEdit = useCallback(
    (id: string) => {
      ...
      const updated = prizes.map((p) => p.id === id ? { ...p, name: trimmed } : p);
      setEditingId(null);
      savePrizes(updated);
    },
  ...
  const deletePrize = useCallback(
    (id: string) => savePrizes(prizes.filter((p) => p.id !== id)),
    [prizes, savePrizes]
  );
  ...
  return (
    <div
      ...
      style={{ background: theme.colors.bg, fontFamily: 'var(--font-psv)' }}
    >
      <div className="max-w-2xl mx-auto">
        ...
        <div className="flex items-center justify-between mb-10">
          <div>
            ...
            >
              <span style={{ color: primary }}>{theme.label}</span> Admin
            </h1>
          ...
          <Link
            ...
            onMouseEnter={(e) => {
              (e.currentTarget as HTMLAnchorElement).style.background = `${primary}40`;
              (e.currentTarget as HTMLAnchorElement).style.color = '#fff';
            }}
            onMouseLeave={(e) => {
              (e.currentTarget as HTMLAnchorElement).style.background = `${primary}1f`;
            ...
            <AnimatePresence initial={false}>
              {prizes.map((prize, index) => (
                <motion.div
                  ...
                  style={{
                    borderBottom: index < prizes.length - 1 ? '1px solid rgba(255,255,255,0.05)' : 'none',
                ...
                >
                  ...
                  <button
                    ...
                    style={{
                      background: prize.active ? primary : 'rgba(255,255,255,0.12)',
                  ...
                  <span
                    ...
                    style={{
                      background: prize.active ? `${primary}2e` : 'rgba(255,255,255,0.06)',
                  ...
                  <button
                    ...
                    style={{ color: 'rgba(255,255,255,0.3)', background: 'transparent', cursor: saving ? 'default' : 'pointer' }}
                    onMouseEnter={(e) => {
                  ...
                  <button
                    ...
                    disabled={saving}
                    className="flex-shrink-0 p-2 rounded-lg transition-colors"
                    style={{ color: `${primary}80`, background: 'transparent', cursor: saving ? 'default' : 'pointer' }}
                    onMouseEnter={(e) => {
                      (e.currentTarget as HTMLButtonElement).style.background = `${primary}1f`;
                      (e.currentTarget as HTMLButtonElement).style.color = primary;
                    }}
                    onMouseLeave={(e) => {
                      (e.currentTarget as HTMLButtonElement).style.background = 'transparent';
                      (e.currentTarget as HTMLButtonElement).style.color = `${primary}80`;
                    }}
                    title="Verwijderen"
                  >
                    <svg width="15" height="15" viewBox="0 0 15 15" fill="none">
            ...
            {addingNew ? (
              ...
              >
                <input
                  ...
                  onKeyDown={(e) => {
                    ...
                    if (e.key === 'Escape') { setAddingNew(false); setNewPrizeName(''); }
                  }}
                ...
                <button
                  ...
                  style={{
                    background: newPrizeName.trim() ? primary : `${primary}4d`,
                ...
                <button
                  onClick={() => { setAddingNew(false); setNewPrizeName(''); }}
              ...
              <button
                ...
                style={{
                  ...
                  border: `1px dashed ${primary}59`,
                  color: 'rgba(255,255,255,0.5)',
                  cursor: 'pointer',
                }}
                onMouseEnter={(e) => {
                  (e.currentTarget as HTMLButtonElement).style.background = `${primary}26`;
                  (e.currentTarget as HTMLButtonElement).style.borderColor = `${primary}99`;
                  (e.currentTarget as HTMLButtonElement).style.color = '#fff';
                }}
                onMouseLeave={(e) => {
                  (e.currentTarget as HTMLButtonElement).style.background = `${primary}14`;
                  (e.currentTarget as HTMLButtonElement).style.borderColor = `${primary}59`;
